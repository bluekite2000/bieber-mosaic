...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' + 
                ...
                '<div class="qq-upload-button">Upload (or drag/drop) your pic here!</div>' +
                '<ul class="qq-upload-list"></ul>' + 
             '</div>',


        // template for one item in file list
        fileTemplate: '<li> Please wait a few mins. Mosaiczing ' +
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _addToList: function(id, fileName){
	   ...
	   //this is a hack by dat so list always has 1 element when it shows on the site
    	var first=this._listElement.firstChild
		if (first) {
			
			this._listElement.replaceChild(item,first)
			}
		else
